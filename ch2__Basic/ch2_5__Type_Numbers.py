...
print(f'({num_1} * {num_2}) * 2 Basic = {result_6}')  # (5 * 10) * 2 Basic = 100
# ---------------------------------------------

result_7 = num_3 * 2
print(f'{num_3} * 2 Basic = {result_7}')  # 2 Basic * 2 Basic = 4
# ---------------------------------------------
...
result_8 = num_3 ** 5
print(f'{num_3} ** 5 = {result_8}')  # 2 Basic ** 5 = 32
# ---------------------------------------------
...
print(f'{num_1} % {num_2} = {result_11}')  # 50 % 8 = 2 Basic
# ---------------------------------------------
